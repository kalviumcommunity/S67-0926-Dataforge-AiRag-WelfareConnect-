...
from backend.app.routers import audit, auth, collections, documents, feedback, health, indexing, search
...
app.include_router(indexing.router, prefix=settings.API_V1_STR)
